...
import com.witelokk.prac10.databinding.DialogAddEditUserBinding;
...
public class StudentsAdapter extends RecyclerView.Adapter<StudentsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        com.witelokk.prac10.databinding.ItemBinding binding;

        public ViewHolder(View view) {
            super(view);
            binding = com.witelokk.prac10.databinding.ItemBinding.bind(view);
        }
